...
from src.core.models.geoaware_blocks import CoreCNNBlock, CoreAttentionBlock
from src.core.models.util_tools import make_bilinear_upsample, get_activation
...
class phisat2net_geoaware(nn.Module):
    ...
    def forward(self, x):
        ...
        out_dict = {
            ...
            "features": pooled_feats             # (B, dims[-1])
        }
