...
STATS = {
    ...
    "phisat2_l0": {
        "PAN": (2258.0920, 865.9395), "BLUE": (815.6563, 327.4213), "GREEN": (998.2614, 324.7467), "RED": (872.9254, 307.7517),
        "RED_EDGE_1": (608.1836, 123.3780), "RED_EDGE_2": (609.9414, 107.7182), "RED_EDGE_3": (642.1639, 119.6468), "NIR_BROAD": (660.4028, 229.4349)
    },
    #"s2": { # FROM OUR TRIPLET DATASET -> after ESA added offset
