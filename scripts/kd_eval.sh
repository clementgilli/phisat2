#!/bin/bash
#TEACHERS=("terramind_v1_large" "ssl4eos12_vit_small_patch16_224_sentinel2_all_dino" "ssl4eos12_vit_small_patch16_224_sentinel2_all_moco" "dofa_large_patch16_224") #"prithvi_eo_v2_300")
TEACHERS=("prithvi_eo_v2_300")
