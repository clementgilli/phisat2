# ==========================================
# CONFIGURATION : Burned Area — N-Shot Experiments
# ==========================================

MODEL       ?=
NSHOT       = full

BASE_NAME   = burned_$(MODEL)_$(NSHOT)
QUEUE       = gpu4_std
GPUS        = 1
...
ifeq ($(NSHOT), full)
	CKPT_PATH = $(_BASE)/segmentation/burned/$(MODEL)/full_dataset/seed_42/checkpoints/best-v1.ckpt
else
	CKPT_PATH = $(_BASE)/segmentation/burned/$(MODEL)/$(DATASET)_split_$(NSHOT)/seed_42/checkpoints/best.ckpt
endif
