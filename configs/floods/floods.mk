# ==========================================
# CONFIGURATION : Floods — N-Shot Experiments
# ==========================================

MODEL       ?=
NSHOT       = full

BASE_NAME   = floods_$(MODEL)_$(NSHOT)
QUEUE       = gpu4_std
GPUS        = 1
...
ifeq ($(NSHOT), full)
	CKPT_PATH = $(_BASE)/segmentation/floods/$(MODEL)/full_dataset/seed_42/checkpoints/best-v1.ckpt
else
	CKPT_PATH = $(_BASE)/segmentation/floods/$(MODEL)/$(DATASET)_split_$(NSHOT)/seed_42/checkpoints/best.ckpt
endif
